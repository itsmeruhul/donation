...
$qu ="SELECT * FROM donation_post as w join user_details as g on w.Userid=g.Userid where w.amount>0";
...
if($total != 0)
{
  ...
  <section>
  <!--for demo wrap-->
  <h1>Wanted Donation This People</h1>
...
echo"<tr>
		<td>".$result['Name']."</td>
		<td><h3>".$result['postid']."</h3></td>
        <td>".$result['donation_reason']."</td>
        <td>".$result['donation_date']."</td>
		<td>".$result['age']." Years</td>
        <td>Taka = ".$result['amount']."</td>
...
$query ="SELECT SUM(fund) as sumsalary FROM donation_post";
$res = mysqli_query($conn,$query);
$data = mysqli_fetch_array($res);

print "<h1>Totall Fund: ".$data['sumsalary']."</h1>";
?>
