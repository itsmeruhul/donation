...
$HOST="localhost";
 ...
 if(!empty($_POST)){
	...
	$ab="INSERT INTO donation_post(postid,Userid,donation_reason,donation_date,donation_time,amount) 
	VALUES($postid,$userid,'$donation','$date','$time','$amount')"; 
	 if(mysqli_query($con,$ab)){
		 echo "Sucessfully Added Data in the Database";
	 }
 }
...
<html lang="en">
  <head>
    ...
    <title>Post Menu| Donation Management System</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Create A Post For Take Donation</h2>
                </div>
                <div class="card-body">
                    <form method="POST">
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="contact">
                                    <input class="input--style-5" type="text" name="postid">
                                </div>
                            </div>
                        </div>
						
						<div class="form-row">
                            <div class="name">Donation Date</div>
                            <div class="value">
                        ...
                        <div class="form-row">
                            <div class="name">Donation Time</div>
                            <div class="value">
                                <div class="input-group">
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea name="donation" rows="10" cols="130">Why Do you Need Donation?</textarea>
                                </div>
                            </div>
                        </div>
                        <div>
